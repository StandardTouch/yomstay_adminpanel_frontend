  ...
  const data = [
    {
      ...
      amenities: [
        {
          name: "Free WiFi",
          icon: "https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f4f9.png",
        },
        {
          name: "Elevator",
          icon: "https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f6d7.png",
        },
        {
          name: "Fitness room",
        ...
        },
        {
          ...
          icon: "https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f6b9.png",
        },
        {
          name: "Business center",
          icon: "https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f4bc.png",
        },
        {
          name: "Bar / Café",
          icon: "https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f37a.png",
        },
        {
          name: "Breakfast Area",
          icon: "https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f95e.png",
        },
        {
          name: "Meeting room",
          icon: "https://cdn.jsdelivr.net/gh/twitter/twemoji@latest/assets/72x72/1f4bb.png",
        },
      ],
      roomFacilities: [
        { name: "Flat screen TV" },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 pt-5">
              ...
              {Object.keys(showTrue).map((key) => {
                ...
                return (
                  <div
                    key={key}
                    className=" p-4 border-b-2 border shadow rounded-sm"
                  >
                    <h2 className="text-xl font-medium pb-2">
                      {titleMap[key]}
                    </h2>
                    {Array.isArray(allValues[key]) &&
                      allValues[key].length > 0 &&
                      allValues[key].map((item) => (
                        <li
                          className=" flex gap-2 pb-2 text-sm pl-2"
                          key={item.name}
                        >
                          {item.icon && (
